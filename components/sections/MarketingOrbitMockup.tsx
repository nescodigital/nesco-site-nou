...
const CONTENT = {
  ro: {
    ...
    pills: ["6 canale integrate", "Un singur partener", "ROI măsurabil"],
  ...
  en: {
    ...
    pills: ["6 integrated channels", "Single partner", "Measurable ROI"],
  ...
  de: {
    ...
    pills: ["6 integrierte Kanäle", "Ein Partner", "Messbarer ROI"],
