...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/services/performance-marketing/', destination: '/en/paid-ads', permanent: true },
      { source: '/services/social-marketing', destination: '/en/digital-marketing/social-media', permanent: true },
      { source: '/services/social-marketing/', destination: '/en/digital-marketing/social-media', permanent: true },
      { source: '/services/digital-strategy', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/digital-strategy/', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/website-development', destination: '/en/webdesign', permanent: true },
      { source: '/services/website-development/', destination: '/en/webdesign', permanent: true },
      { source: '/services/ecommerce', destination: '/en/webdesign/online-store', permanent: true },
      { source: '/services/ecommerce/', destination: '/en/webdesign/online-store', permanent: true },
      { source: '/services/ecommerce-consulting', destination: '/en/webdesign/online-store', permanent: true },
      { source: '/services/ecommerce-consulting/', destination: '/en/webdesign/online-store', permanent: true },
      { source: '/services/cro-conversion-rate-optimization', destination: '/en/digital-marketing/cro', permanent: true },
      { source: '/services/cro-conversion-rate-optimization/', destination: '/en/digital-marketing/cro', permanent: true },
      { source: '/services/marketing-automation', destination: '/en/digital-marketing/email-marketing', permanent: true },
      { source: '/services/marketing-automation/', destination: '/en/digital-marketing/email-marketing', permanent: true },
      { source: '/services/marketing-strategy', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/marketing-strategy/', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/brand-strategy', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/brand-strategy/', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/digital-transformation-consulting', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/digital-transformation-consulting/', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/digital-auditing', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      { source: '/services/digital-auditing/', destination: '/en/digital-marketing/digital-strategy', permanent: true },
      ...
      { source: '/despre-nesco-digital', destination: '/despre-noi', permanent: true },
