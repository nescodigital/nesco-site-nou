...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: '/ro/servicii-marketing/performance-marketing-ro/', destination: '/reclame-platite', permanent: true },
      { source: '/ro/servicii-marketing/strategie-digitala', destination: '/strategie-digitala-ro', permanent: true },
      { source: '/ro/servicii-marketing/strategie-digitala/', destination: '/strategie-digitala-ro', permanent: true },
      { source: '/ro/servicii-marketing/ecommerce-ro', destination: '/magazine-online-ro', permanent: true },
      { source: '/ro/servicii-marketing/ecommerce-ro/', destination: '/magazine-online-ro', permanent: true },
      ...
      { source: '/ro/servicii-marketing/cro-optimizarea-ratei-de-conversie/', destination: '/solutii-cro-ro', permanent: true },
      { source: '/ro/servicii-marketing/marketing-automatizat', destination: '/solutii-email-marketing-ro', permanent: true },
      { source: '/ro/servicii-marketing/marketing-automatizat/', destination: '/solutii-email-marketing-ro', permanent: true },
      { source: '/ro/servicii-marketing/social-marketing-ro', destination: '/solutii-social-media-ro', permanent: true },
      { source: '/ro/servicii-marketing/social-marketing-ro/', destination: '/solutii-social-media-ro', permanent: true },
      ...
      { source: '/site-de-lead-generation', destination: '/website-lead-generation-ro', permanent: true },
      { source: '/website-companie', destination: '/website-companie-ro', permanent: true },
      { source: '/magazine-e-commerce', destination: '/magazine-online-ro', permanent: true },
      { source: '/solutii-cro', destination: '/solutii-cro-ro', permanent: true },
      { source: '/solutii-social-media-marketing-ro', destination: '/solutii-social-media-ro', permanent: true },
