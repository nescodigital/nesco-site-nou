...
const data: ServicePageData = {
  ...
  hero: {
    ...
    subtitle: "Visual, impactful, convertible. We create Instagram campaigns that stop the scroll, build brand desire, and drive real conversions through Stories, Reels, Feed, and Shopping.",
  },
  problems: [
    { title: "Your profile reach is limited", desc: "A profile with 10,000 followers organically reaches at most 5–10% of them. Your products deserve to be seen by far more people." },
    { title: "Competitors are running Instagram ads", desc: "If you're not active with ads, your place in potential customers' feeds is taken by your competitors." },
    { title: "Your ideal customer is on Instagram", desc: "If you sell visual products or services (fashion, beauty, food, home, fitness), your ideal audience lives on Instagram." },
  ...
  cases: [
    { metric: "+45%", label: "ROAS improvement in 60 days", industry: "Fashion E-commerce" },
    { metric: "+120%", label: "New website traffic from Instagram", industry: "Lifestyle Brand" },
    ...
    { metric: "+80%", label: "Orders from Instagram Shopping", industry: "Fashion" },
  ...
  testimonial: { quote: "We launched a new cosmetics brand and in 3 months Instagram Ads brought us 1,200 new orders. The visuals created by Nesco converted far better than anything we had done ourselves.", name: "Andreea M.", role: "Founder, natural cosmetics brand" },
            ...
            <>
              <AdsTrustBar
                items={[
                  ...
                  { stat: "5M+", label: "Instagram RO users" },
              ...
              <AdsBeforeAfter
                ...
                before={[
                  ...
                  { label: "Instagram Shopping", display: "not active" },
                ]}
                after={[
              ...
              <AdsComparison
                ...
                goodLabel="✓  Professional with Nesco"
                bad={[
                  "Post boost without audience strategy",
                  "Same creative for months on end",
                  "Instagram Shopping not activated",
                  "No retargeting on website visitors",
                ...
                phases={[
                  {
                    ...
                    color: "#f472b6",
                    items: [
                      "Instagram profile and Business Manager audit",
                      "Instagram Shopping and product catalog setup",
                      "Audience definition and creative strategy",
                      "First Stories and Feed campaigns launched",
                    ],
                  },
                  {
                    emoji: "🎨",
                    ...
                    color: "#a78bfa",
                    items: [
                      "Stories vs Reels vs Feed testing",
                      "Optimization based on CTR and ROAS",
                      "Retargeting launched for website visitors",
                      "A/B testing 5+ creatives per week",
                    ],
                  },
                  {
                    emoji: "🚀",
                    range: "Days 46–90",
                    title: "Scale & Shopping",
                    color: "#56db84",
                    items: [
                      "Budget scaling on winning formats",
                      "Instagram Shopping flow optimization",
