        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            buildServiceSchema({
              ...
              description:
                "High-performance Facebook Ads campaigns generating leads, increasing sales and brand awareness.",
            ...
            <>
              ...
              <AdsComparison
                ...
                bad={[
                  ...
                  "Broad audiences with no segmentation",
                  "One creative running 6+ months",
                  "Zero remarketing or retargeting",
                  "Reporting: likes and reach",
                  "No Pixel installed correctly",
                ]}
                good={[
                  ...
                  "Remarketing to all site visitors + cart abandonments",
