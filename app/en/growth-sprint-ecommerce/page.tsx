...
export const metadata: Metadata = buildMetadata({
  locale: "en",
  title: "Growth Sprint for E-Commerce | Fix Revenue Leaks | Nesco Digital",
  description:
    "A focused 6-week engagement for e-commerce brands doing 50k–500k+/month. We audit every revenue system and implement the highest-impact fixes in acquisition, conversion, retention and ops.",
  path: "/en/growth-sprint-ecommerce/",
  routeKey: "growthSprintEcommerce",
});

const included = {
  audit: [
    ["Paid acquisition audit", "ROAS, CPM, funnel efficiency, budget allocation"],
    ["Product page & checkout analysis", "Where you're losing buyers"],
    ["Email and SMS revenue audit", "Flows, sequences, revenue per subscriber"],
    ["AOV and LTV structure", "Upsells, bundles, repeat purchase rates"],
    ["Operational review", "Fulfilment friction, team bottlenecks, process gaps"],
    ["KPI and tracking structure", "Are you measuring what actually matters?"],
  ],
  impl: [
    ["Fix conversion and retention leaks", "The highest-impact gaps from the audit"],
    ["Rebuild email and SMS flows", "Underperforming flows rebuilt"],
    ["Restructure acquisition strategy", "For profitability, not just volume"],
    ["Implement AOV and LTV improvements", "Upsell flows, bundle structures"],
    ["Set up clean KPI tracking", "Reporting systems that tell you what matters"],
  ],
};

const forList = [
  "E-commerce brands at 50k–500k+/month with real ad spend and existing operations",
  "Founders who feel growth has stalled despite increased marketing spend",
  "Business owners who want an operator, not another vendor",
  "Brands with an existing tech stack, Shopify, Klaviyo, Meta, Google, ready to be optimized",
];

const notForList = [
  "Brands that haven't reached consistent monthly revenue",
  "Businesses looking for someone to manage their day-to-day ads",
  "Founders who want strategy slides, not implementation",
];
      ...
      <main style={{ backgroundColor: "#050505" }}>
        ...
        >
          ...
          <div className="relative page-container" style={{ zIndex: 1 }}>
            ...
            >
              For mid to high ticket e-commerce brands doing{" "}
              <strong style={{ color: "#ffffff", fontWeight: 700 }}>50k–500k+/month</strong>{" "}
              who are scaling ad spend but not scaling profit.
            </p>
            <p
              style={{
                fontSize: "1rem",
            ...
            >
              {[
                ...
                { value: "50k–500k+", label: "Revenue per month" },
                { value: "No reports", label: "Implementation only" },
              ].map((s, i) => (
                <div key={i}>
                  <div
          ...
          <div className="page-container">
            <FadeInSection>
              <div style={{ maxWidth: "680px" }}>
                ...
                >
                  You&apos;re scaling ad spend.{" "}
                  <span style={{ color: "rgba(255,255,255,0.35)" }}>You&apos;re not scaling profit.</span>
                </h2>
                <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                  <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.8 }}>
                    You&apos;re running ads. You have traffic. You&apos;re processing orders. But your margins are tighter than they should be, your ROAS keeps dropping, and the more you spend, the less profitable it feels.
                  </p>
                  <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.8 }}>
                    You&apos;ve optimized what you can see, the ads, maybe the homepage. But the real leaks are hidden: in your funnel drop-offs, your email and SMS underperformance, your AOV and LTV gaps, and the operational friction that quietly kills efficiency.
                  </p>
                  <p
                    style={{
                      fontSize: "1rem",
                  ...
                  >
                    You don&apos;t need another agency to manage your campaigns. You need someone to go inside the business, find where the money is leaking, and{" "}
                    <span style={{ color: "#56db84" }}>close the gaps.</span>
                  </p>
                </div>
              </div>
            </FadeInSection>
          ...
          <div className="page-container">
            <FadeInSection>
              ...
              >
                ...
                >
                  We don&apos;t produce reports. We implement.
                </h2>
                <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.8, marginBottom: "16px" }}>
                  A focused 6-week engagement where Nesco Digital operates directly inside your e-commerce business, auditing every revenue system and implementing the highest-impact fixes across acquisition, conversion, retention, and operations.
                </p>
            ...
            <FadeInSection>
              <div style={{ textAlign: "center", marginBottom: "64px" }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "1rem" }}>
                  Two clear phases. One goal: more profit.
                </p>
              </div>
            </FadeInSection>
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.7 }}>
                    A more profitable, better-converting revenue system, implemented, documented, and ready to scale.{" "}
        ...
        {/* ── Investment ── */}
        <section id="investment" className="relative" style={{ backgroundColor: "#050505", padding: "100px 0" }}>
          <div
            className="absolute top-0 left-0 right-0 h-px"
            style={{ background: "linear-gradient(90deg, transparent, rgba(255,255,255,0.06), transparent)" }}
          />
          <div className="page-container">
            <FadeInSection>
              <div style={{ textAlign: "center", marginBottom: "64px" }}>
                ...
                <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "1rem" }}>
                  Two options. Same 6-week engagement.
                </p>
              </div>
            </FadeInSection>
              ...
              <FadeInSection delay={120}>
                ...
                >
                  ...
                  <p style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.35)", marginBottom: "8px", lineHeight: 1.6 }}>
                    3,250 € at signing + 3,250 € at Week 3
                  </p>
