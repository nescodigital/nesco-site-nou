...
const SPECIALISTS = [
  { id: "paid-ads", label: "Paid Ads Specialist (Google, Meta, TikTok)" },
  { id: "seo", label: "SEO Specialist" },
  { id: "webdesign", label: "Web Designer / Developer" },
  { id: "email", label: "Email Marketing Specialist" },
  { id: "manager", label: "Marketing Manager / Strategist" },
];

const EXPERIENCE_OPTIONS = [
  { value: "junior", label: "Junior", sublabel: "1-2 years", factor: 0.7 },
  { value: "mid", label: "Mid", sublabel: "3-5 years", factor: 1.0 },
  { value: "senior", label: "Senior", sublabel: "5+ years", factor: 1.5 },
];
...
export function CalculatorClientEN() {
    ...
    <div style={{ backgroundColor: "#050505" }}>
      ...
      >
        ...
        <div className="relative page-container">
          ...
          >
            In-House or Agency?<br />Calculate the Real Cost
          </h1>
          <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, maxWidth: "560px", letterSpacing: "0.01em" }}>
            Discover what hides behind a salary and how much an in-house marketing specialist truly costs compared to Nesco Digital.
          </p>
        </div>
      </section>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div style={{ marginBottom: "28px" }}>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
                    <span style={{ fontSize: "0.75rem", fontWeight: 600, color: "rgba(255,255,255,0.4)", letterSpacing: "0.1em", textTransform: "uppercase" }}>
                      Desired net salary per specialist
                    </span>
                  ...
                  {experience !== "mid" && (
                    <div style={{ marginTop: "8px", fontSize: "0.8125rem", color: "rgba(255,255,255,0.35)" }}>
                      Effective salary with {expFactor}x factor:{" "}
              ...
              <div style={{ padding: "20px 24px", background: "#0a0a0a", border: "1px solid rgba(255,255,255,0.06)", borderRadius: "16px" }}>
                <div style={{ fontSize: "0.75rem", fontWeight: 600, color: "rgba(255,255,255,0.3)", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "12px" }}>
                  Cost breakdown per specialist / month
                </div>
                {[
                  { label: "Gross salary (net x 1.7)", value: fmt(gross) },
                  { label: "Equipment, software, licenses", value: fmt(equipment) },
                  { label: "Training and courses", value: fmt(training) },
                  { label: "Office space (estimated)", value: fmt(office) },
                  { label: "Turnover risk (monthly provisions)", value: fmt(rotationRisk) },
                ].map(row => (
                  <div
                    key={row.label}
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", paddingTop: "10px", marginTop: "4px" }}>
                  ...
                  <span style={{ color: "#56db84", fontWeight: 700, fontSize: "1rem" }}>{fmt(perSpecialistCost)}/mo</span>
                </div>
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              ...
              <div style={{ padding: "32px", background: "rgba(86,219,132,0.06)", border: "1px solid rgba(86,219,132,0.2)", borderRadius: "20px" }}>
                ...
                <div className="font-black tabular-nums" style={{ fontSize: "clamp(2rem, 5vw, 3rem)", color: "#56db84", lineHeight: 1, letterSpacing: "-0.03em" }}>
                  ...
                  <span style={{ fontSize: "1rem", opacity: 0.55, fontWeight: 400 }}>/mo</span>
                </div>
                <div style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.35)", marginTop: "10px", lineHeight: 1.6 }}>
                  The difference between total in-house cost and Nesco Digital
                </div>
              </div>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px" }}>
                <div style={{ padding: "24px", background: "rgba(86,219,132,0.04)", border: "1px solid rgba(86,219,132,0.12)", borderRadius: "16px" }}>
                  ...
                  <div style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.3)", marginTop: "6px" }}>
                    {"\u2248"} {equivalentSalaries} salaries / year
                  </div>
                </div>
                <div style={{ padding: "24px", background: "rgba(96,165,250,0.04)", border: "1px solid rgba(96,165,250,0.12)", borderRadius: "16px" }}>
                  ...
                  <div style={{ marginBottom: "6px" }}>
                    <span style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.3)" }}>In-house: </span>
                    <span style={{ fontSize: "0.875rem", color: "#fff", fontWeight: 600 }}>3-6 months</span>
                  </div>
                  <div>
                    <span style={{ fontSize: "0.75rem", color: "rgba(255,255,255,0.3)" }}>Nesco: </span>
                    <span style={{ fontSize: "0.875rem", color: "#60a5fa", fontWeight: 600 }}>2-4 weeks</span>
                  </div>
                  <div style={{ fontSize: "0.75rem", color: "rgba(96,165,250,0.5)", marginTop: "6px" }}>~4 months gained</div>
                </div>
              </div>
              ...
              <div style={{ padding: "14px 18px", background: "rgba(255,255,255,0.02)", border: "1px solid rgba(255,255,255,0.05)", borderRadius: "12px" }}>
                <span style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.3)", lineHeight: 1.6 }}>
                  <span style={{ color: "#56db84", fontWeight: 600 }}>Nesco Digital includes:</span>{" "}
                  strategy, execution, reporting, and guaranteed continuity across all selected channels.
                </span>
              </div>
            </div>
          </div>
      ...
      <section className="relative" style={{ backgroundColor: "#050505", padding: "80px 0 100px" }}>
        ...
        <div className="page-container">
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <span className="badge mb-4" style={{ display: "inline-flex" }}>Detailed comparison</span>
            <h2
              className="font-black text-white"
              style={{ fontSize: "clamp(1.75rem, 3.5vw, 2.5rem)", lineHeight: 1.1, letterSpacing: "-0.025em", marginTop: "16px" }}
            >
              In-House vs Nesco Digital
            </h2>
          </div>
          <div style={{ overflowX: "auto" }}>
            <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: 0, minWidth: "580px" }}>
              <thead>
                <tr>
                  <th style={{ padding: "14px 20px", textAlign: "left", fontSize: "0.75rem", color: "rgba(255,255,255,0.3)", fontWeight: 600, letterSpacing: "0.08em", textTransform: "uppercase" }}>Criterion</th>
                  <th style={{ padding: "14px 20px", textAlign: "center", fontSize: "0.875rem", color: "rgba(255,100,100,0.6)", fontWeight: 600 }}>In-House Employee</th>
              ...
              <tbody>
                {[
                  { criterion: "Monthly cost", intern: fmt(totalInternMonthly), nesco: fmt(nescoCost) },
                  { criterion: "Setup & onboarding", intern: "3-6 months", nesco: "2-4 weeks" },
                  { criterion: "Channel coverage", intern: "1 channel / person", nesco: "All channels" },
                  { criterion: "Turnover risk", intern: "High (40%/year)", nesco: "Zero" },
                  { criterion: "Know-how on departure", intern: "Completely lost", nesco: "Stays with you" },
                  { criterion: "Reporting", intern: "Internal, inconsistent", nesco: "Live dashboard" },
                  { criterion: "Rapid scaling", intern: "New hire (3-6 months)", nesco: "Immediate" },
                ].map((row, idx) => (
                  <tr key={idx}>
      ...
      <section className="relative" style={{ backgroundColor: "#050505", padding: "0 0 100px" }}>
        ...
        <div className="page-container" style={{ paddingTop: "80px" }}>
          <div style={{ textAlign: "center", marginBottom: "48px" }}>
            <span className="badge mb-4" style={{ display: "inline-flex" }}>Hidden costs</span>
            <h2
              className="font-black text-white"
              style={{ fontSize: "clamp(1.75rem, 3.5vw, 2.5rem)", lineHeight: 1.1, letterSpacing: "-0.025em", marginTop: "16px" }}
            >
              What doesn&apos;t show up on the payslip
            </h2>
          </div>
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
            {[
              { icon: "\uD83D\uDD0D", title: "Recruitment cost", desc: "1-3 months of searching + recruitment agency (10-20% of annual salary) + management time for interviews." },
              { icon: "\u23F3", title: "Onboarding", desc: "3-6 months until a new hire performs at full capacity. You pay for 50% productivity during this period." },
              { icon: "\uD83D\uDD04", title: "Staff turnover", desc: "40% of marketing employees leave within the first year. Back to square one: recruitment, onboarding, lost know-how." },
              { icon: "\uD83D\uDCB0", title: "Opportunity cost", desc: "While your employee is still learning, your competitors with agencies are already optimizing and growing." },
            ].map((card, idx) => (
              <div
                key={idx}
      ...
      >
        ...
        <div style={{ position: "relative", zIndex: 1, maxWidth: "48rem", width: "100%", margin: "0 auto", textAlign: "center", padding: "0 2rem" }}>
          ...
          >
            Ready to calculate your real-world scenario?
          </h2>
          <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.7, marginBottom: "40px", maxWidth: "460px", marginLeft: "auto", marginRight: "auto" }}>
            Let&apos;s chat for 30 minutes and we&apos;ll present you with a personalized offer.
          </p>
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "16px" }}>
            ...
            >
              Or send us your calculation via email
            </a>
          </div>
        </div>
      </section>
