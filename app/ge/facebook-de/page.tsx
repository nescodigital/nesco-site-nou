...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Facebook und Instagram Ads die konvertieren. Präzises Targeting, leistungsstarke Creatives, kontinuierliche Optimierung. Bewährte Meta-Agentur.",
  path: "/ge/facebook-de/",
...
export default function FacebookDePage() {
  return (
    <>
            ...
            <>
              <AdsTrustBar
                items={[
                  ...
                  { stat: "36M€+", label: "verwaltete Budgets" },
              ...
              <AdsBeforeAfter
                ...
                before={[
                  ...
                  { label: "Reichweite/Monat", display: "12.000" },
                  { label: "CTR", display: "0,4%" },
                  { label: "Strategie", display: "Post boosten" },
                  { label: "Reporting", display: "Likes & Reichweite" },
                ]}
                after={[
                  { label: "ROAS", display: "6,2x", animate: { target: 6.2, decimals: 1, suffix: "x" } },
                  { label: "CPL", display: "24 Lei", animate: { target: 24, suffix: " lei" } },
                  { label: "Reichweite/Monat", display: "428.000", animate: { target: 428000 } },
              ...
              <AdsComparison
                ...
                bad={[
                  "Posts boosten ohne Strategie",
                  "Breite Zielgruppen ohne Segmentierung",
                  "Ein Creative über 6+ Monate",
                  "Kein Remarketing oder Retargeting",
                  "Reporting: Likes und Reichweite",
                  "Kein korrekt installiertes Pixel",
                ]}
                good={[
                  "TOF/MOF/BOF-Funnel mit strategisch verteilten Budgets",
                  "Lookalike Audiences + Interessen + Verhaltensweisen",
                  "Creative-Refresh alle 2-3 Wochen",
                  "Remarketing an alle Website-Besucher + Warenkorbabbrecher",
                  "Reporting: ROAS, CPL, Umsatz",
                ...
                phases={[
                  {
                    ...
                    color: "#60a5fa",
                    items: [
                      "Meta-Konto- und Pixel-Audit",
                      "Vollständiges Business Manager Setup",
                      "Zielgruppen und Content-Strategie definieren",
                      "Erste TOF-Kampagnen erstellen",
                      "Conversions API installieren",
                    ],
                  },
                  {
                    emoji: "🎨",
                    ...
                    color: "#a78bfa",
                    items: [
                      "5-10 Creatives pro Woche testen",
                      "Datenbasierte Optimierung (CTR, CPL, ROAS)",
                      "MOF- und Retargeting-Kampagnen starten",
                      "A/B-Testing von Zielgruppen und Zielen",
                    ],
                  },
                  {
                    emoji: "🚀",
                    ...
                    color: "#56db84",
                    items: [
                      "Budgets für gewinnende Kampagnen skalieren",
                      "BOF- und Kundenbindungskampagnen starten",
                      "Lookalike Audiences aus Konvertierten",
      ...
      <AdsStickyBar
        title="Bereit mit Facebook Ads zu wachsen?"
