...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  if (!project) return {};
  const lp = getLocalizedProject(project, "de");
  return buildMetadata({
    locale: "de",
    title: lp.metaTitle,
    description: lp.metaDescription,
    path: `/ge/projekte/${project.slug}/`,
    routeKey: "projects",
  });
}

export default async function ProjectDePage({ params }: Props) {
  const { slug } = await params;
  const project = getProjectBySlug(slug);
  if (!project) notFound();
  const lp = getLocalizedProject(project, "de");
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                  <Link href={`/ge/lass-uns-reden/?source=project-${project.slug}`} className="btn-primary">
                    Projekt besprechen
                    <ArrowRight size={16} />
                  </Link>
                  <Link
          ...
          <div className="page-container">
            <FadeInSection>
              <div style={{ textAlign: "center", marginBottom: "64px" }}>
                <span className="badge mb-6">Ergebnisse</span>
                <h2
                  className="font-black text-white"
                  style={{
          ...
          <div className="page-container">
            <FadeInSection>
              <div style={{ maxWidth: "640px", margin: "0 auto", textAlign: "center" }}>
                <span className="badge mb-6">Verwendete Dienste</span>
                <h2
                  className="font-black text-white"
                  style={{
