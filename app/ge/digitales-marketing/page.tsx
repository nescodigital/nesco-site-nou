...
const serviceCards = [
  {
    ...
    desc: "Klarer Wachstumsplan auf Datenbasis. Audit, Ziele, KPIs und ausführbare Roadmap.",
    price: "Ab 800 EUR/Monat",
    href: r.digitalStrategy,
  },
  {
    Icon: Mail,
    title: "E-Mail-Marketing",
    desc: "Automatisierte Kampagnen mit nachgewiesenem ROI 42:1. Klaviyo, Mailchimp, ActiveCampaign.",
    price: "Ab 600 EUR/Monat",
    href: r.emailMarketing,
  },
  {
    Icon: Users,
    title: "CRM-Lösungen",
    desc: "Implementierung und Optimierung von HubSpot, Salesforce, Zoho. Automatisierte Pipeline.",
    price: "Ab 700 EUR/Monat",
    href: r.crmSolutions,
  },
  {
    Icon: BarChart3,
    title: "CRO-Lösungen",
    desc: "A/B-Testing, Heatmaps, Conversion-Optimierung. Mehr Verkäufe, gleiches Budget.",
    price: "Ab 900 EUR/Monat",
    href: r.croSolutions,
  },
  {
    Icon: Search,
    title: "SEO",
    desc: "Hochwertiger organischer Traffic. Technical SEO, Content-Strategie, Link-Building.",
    price: "Ab 800 EUR/Monat",
    href: r.seoSolutions,
  },
  {
    Icon: Share2,
    title: "Social Media",
    desc: "Community, Engagement und Content, der auf allen Plattformen konvertiert.",
    price: "Ab 500 EUR/Monat",
    href: r.socialMedia,
  },
];

const orbitLabels = ["SEO", "E-Mail\nMarketing", "CRM", "CRO", "Social\nMedia", "GEO"];

const chartData = {
  months: [1, 2, 3, 4, 5, 6],
  lines: [
    {
      label: "E-Mail-Marketing (ROI 42:1)",
      color: "#56db84",
    ...
    {
      label: "Branchendurchschnitt (ROI 2:1)",
...
const comparisonRows = [
  ...
  {
    feature: "Reporting",
    standard: "Statisches PDF",
    freelancer: "Excel",
    nesco: "KPIs in Echtzeit",
    standardOk: false,
    freelancerOk: false,
  },
  {
...
const tickerItems = [
  ...
  "E-Com-Umsatz +210%",
  "CRM-Pipeline +3x",
  "E-Mail-Öffnungsrate 38%",
  "Absprungrate -28%",
  "Qualifizierte Leads +90%",
...
/* ----- PAGE COMPONENT ----- */
export default function DigitalesMarketingPage() {
      ...
      <main style={{ backgroundColor: "#050505", overflowX: "hidden" }}>
        ...
        >
          ...
          <div className="relative page-container">
            ...
            >
              <span style={{ color: "#fff" }}>Digitales Marketing das</span>
              <br />
              <span
                style={{
            ...
            >
              Wir machen kein Marketing um des Marketings willen. Jeder investierte Euro
              muss multipliziert zurückkommen. Strategie, Umsetzung und kontinuierliche
              Optimierung, alles unter einem Dach.
            </p>
        ...
        <section className="relative" style={{ padding: "100px 0" }}>
          ...
          <div className="page-container">
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              >
                Jeder Kanal arbeitet synchron für ein kohärentes und profitables digitales Ökosystem.
              </p>
            </div>
        ...
        <section className="relative" style={{ padding: "100px 0" }}>
          ...
          <div className="page-container">
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              >
                Messbare Ergebnisse über die Zeit
              </h2>
              <p
                style={{
                  fontSize: "1rem",
              ...
              >
                ROI-Entwicklung nach Hauptkanälen in den ersten 6 Monaten der Zusammenarbeit.
              </p>
            </div>
        ...
        <section className="relative" style={{ padding: "100px 0" }}>
          ...
          <div className="page-container">
            <div style={{ textAlign: "center", marginBottom: 64 }}>
              ...
              >
                Vollständige Lösungen, klare Preise
              </h2>
            </div>
              ...
              <table style={{ width: "100%", borderCollapse: "separate", borderSpacing: 0 }}>
                <thead>
                  <tr>
                    ...
                    {[
                      { label: "Standard-Agentur", isNesco: false },
