...
const ARTICLES = [
  {
    ...
    excerpt:
      "Detaillierter Kostenvergleich: Gehalt, Steuern, Tools, Management — vs. ein All-Inclusive-Agenturpaket. Die echten Zahlen, die niemand zeigt.",
  ...
  },
  {
    ...
    excerpt:
      "Wenn du Geld für Facebook- und Instagram-Ads ohne Ergebnisse ausgibst, ist die Plattform nicht das Problem. Entdecke die 7 Fehler, die deine Kampagnen sabotieren.",
  ...
  },
  {
    ...
    excerpt:
      "Organischer oder bezahlter Traffic? Wir analysieren Kosten, Timeline und ROI jeder Strategie, damit du die richtige Entscheidung für dein Unternehmen triffst.",
