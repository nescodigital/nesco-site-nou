...
const TICKER_STATS = [
  "Durchschnittlicher ROAS: 4,2x",
  "Cost per Lead um 38% reduziert",
  "23.000+ Kampagnen durchgeführt",
  "36M+ Budget verwaltet",
];
...
const PLATFORM_CARDS: PlatformCard[] = [
  ...
  {
    label: "Instagram Ads",
    desc: "Visuell, wirkungsvoll und konvertierend. Wir erreichen Ihre Zielgruppe mit Formaten, die den Scroll stoppen.",
    href: r.instagramAds,
    accentColor: "#d6249f",
    icon: (
      <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden="true">
        <defs>
          <linearGradient id="ig-grad-hub-de" x1="0" y1="1" x2="1" y2="0">
  ...
  {
    label: "TikTok Ads",
    desc: "Gen Z und Millennials mit nativer Kreativität erreichen. Video-Formate, die Brand Awareness und Conversions erzeugen.",
    href: r.tiktokAds,
    accentColor: "#ffffff",
    icon: (
      <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden="true">
  ...
  {
    label: "LinkedIn Ads",
    desc: "Premium B2B-Lead-Generierung. Wir erreichen Entscheider in Zielunternehmen mit relevanten Botschaften.",
    href: r.linkedinAds,
    accentColor: "#0A66C2",
    icon: (
      <svg viewBox="0 0 24 24" width="44" height="44" aria-hidden="true">
...
const MARQUEE_ITEMS = [
  ...
  "Privatklinik: CPA 42% gesenkt",
  "Automobil-Händler: +310% Leads",
  "Online-Retailer: 2,1M Revenue/Monat aus Ads",
  "Delivery-App: 31% Cost per Install reduziert",
  "Elektronik & IT: ROAS 6,1x",
  "Sport & Outdoor Retail: +280% Conversions",
  "HR & Recruiting: 38% CPL reduziert",
  "Online-Apotheke: +195% Revenue aus Paid Ads",
  "Hypermarkt: 4,9x durchschn. ROAS",
];
...
const OBJECTION_CARDS: ObjectionCard[] = [
  {
    front: "Wir wissen nicht, ob es sich lohnt",
    back: "Durchschnittlicher ROI 4,2x in den ersten 90 Tagen. Wir berechnen gemeinsam den Break-even, bevor wir irgendeinen Vertrag unterzeichnen.",
    icon: "❓",
  },
  {
    front: "Wir haben bereits einen internen Spezialisten",
    back: "Interner Spezialist: 3.500-5.000 EUR/Monat plus Benefits, deckt 1-2 Plattformen ab. Nesco-Team: alle Plattformen, keine Fixkosten, Erfahrung mit 36M+ Budgets.",
    icon: "👤",
  },
  {
    front: "Wir haben es schon versucht und es hat nicht funktioniert",
    back: "Wir bieten ein kostenloses Audit des bestehenden Kontos an. Wir identifizieren genau, was schiefgelaufen ist, und präsentieren einen konkreten Plan vor jeder Zusammenarbeit.",
    icon: "🔄",
  },
];
...
const STATS: StatItem[] = [
  { prefix: "+", value: 36, suffix: "M", label: "Verwaltetes Budget" },
  { prefix: "+", value: 23000, suffix: "", label: "Kampagnen durchgeführt" },
  { prefix: "+", value: 4.2, suffix: "x", label: "Ø ROAS", decimals: 1 },
  { prefix: "+", value: 500, suffix: "", label: "Kunden" },
];
...
export default function BezahlteWerbungPage() {
    ...
    <>
      ...
      <style>{`
        ...
        @keyframes mobileGlowPulse {
          0%, 100% { box-shadow: 0 0 6px rgba(86,219,132,0.8); }
          50%       { box-shadow: 0 0 12px rgba(86,219,132,1); }
        }
      `}</style>
          ...
          <div className="relative page-container">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
              ...
              <div>
                ...
                >
                  Wir verwalten keine Budgets. Wir bauen profitable Akquisitionssysteme auf
                  Google, Meta, TikTok und LinkedIn und sagen Ihnen als Erste, wenn wir nicht
                  helfen können.
                </p>
        ...
        >
          ...
          <div className="page-container">
            <div style={{ textAlign: "center", marginBottom: "64px" }}>
              ...
              >
                Zertifizierte Expertise auf allen relevanten Paid-Media-Kanälen
        ...
        >
          ...
          <div className="page-container">
            <div style={{ textAlign: "center", marginBottom: "64px" }}>
              ...
              >
                Wie wir Budget in Umsatz verwandeln
              </h2>
            </div>
            ...
            >
              {[
                { label: "Budget", sublabel: "Monatliches Input" },
                { label: "Strategie", sublabel: "Segmentierung & Creative" },
                { label: "Kampagnen", sublabel: "Kontinuierliche Optimierung" },
                { label: "Conversions", sublabel: "Lead / Verkauf" },
                { label: "Umsatz", sublabel: "Messbarer ROI" },
              ].map((step, i, arr) => (
                <FlowStep
                  key={step.label}
                  label={step.label}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5" style={{ marginTop: "32px" }}>
              {[
                {
                  title: "Audit & Setup",
                  desc: "Wir analysieren das bestehende Konto (falls vorhanden) und bauen die optimale Kampagnenstruktur auf.",
                  duration: "Woche 1",
                },
                {
                  title: "Kontinuierliche Optimierung",
                  desc: "Tägliche Anpassungen auf Basis echter Daten: Bid-Management, A/B-Testing, Zielgruppen.",
                  duration: "Laufend",
                },
                {
                  title: "Transparentes Reporting",
                  desc: "Live-Dashboard mit allen relevanten KPIs. Kein Jargon, keine versteckten Daten.",
                  duration: "Monatlich + Ad-hoc",
                },
              ].map((item) => (
                <div
                  key={item.title}
        ...
        >
          ...
          <div className="page-container">
            <div style={{ textAlign: "center", marginBottom: "64px" }}>
              ...
              >
                Hover über jede Karte, um die Antwort zu sehen.
              </p>
            </div>
