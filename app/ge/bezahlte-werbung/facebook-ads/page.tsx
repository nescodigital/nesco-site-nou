...
export const metadata: Metadata = buildMetadata({
  ...
  description:
    "Facebook- und Instagram-Ads-Kampagnen, die konvertieren. Praezises Targeting, leistungsstarke Creatives, kontinuierliche Optimierung. Bewährte Meta-Agentur.",
            ...
            <>
              ...
              <AdsBeforeAfter
                ...
                before={[
                  ...
                  { label: "Reach/Monat", display: "12.000" },
                ...
                after={[
                  ...
                  { label: "Reach/Monat", display: "428.000", animate: { target: 428000 } },
                  { label: "CTR", display: "3.8%" },
                  { label: "Strategie", display: "Full-Funnel" },
                  { label: "Reporting", display: "ROAS & Revenue" },
                ]}
                source="E-Commerce Fashion, Rumaenien 60 Tage"
              />
              <AdsComparison
                bad={[
                  "Beitraege boosten ohne Strategie",
                  "Breite Zielgruppen ohne Segmentierung",
                  "Ein einziges Creative seit 6+ Monaten",
                  "Kein Remarketing oder Retargeting",
                  "Reporting: Likes und Reichweite",
                  "Kein Pixel korrekt installiert",
                ]}
                good={[
                  "TOF/MOF/BOF-Funnel mit strategisch verteilten Budgets",
                  "Lookalike Audiences + Interessen + Verhalten",
                  "Creative-Refresh alle 2-3 Wochen",
                  "Remarketing auf alle Website-Besucher + Warenkorbabbrecher",
                ...
                phases={[
                  {
                    ...
                    color: "#60a5fa",
                    items: [
                      "Audit Meta-Konto und Pixel",
                      "Vollstaendiges Business Manager Setup",
                      "Definition von Zielgruppen und Content-Strategie",
                      "Erstellung der ersten TOF-Kampagnen",
                      "Installation Conversions API",
                    ],
                  },
                  {
                    emoji: "🎨",
                    ...
                    color: "#a78bfa",
                    items: [
                      "Test von 5-10 Creatives/Woche",
                      "Datenbasierte Optimierung (CTR, CPL, ROAS)",
                      "Start von MOF- und Retargeting-Kampagnen",
                  ...
                  },
                  {
                    ...
                    color: "#56db84",
                    items: [
                      "Budget-Skalierung auf erfolgreiche Kampagnen",
                      "Start von BOF- und Loyalitaetskampagnen",
                      "Lookalike Audiences basierend auf Kaeufer",
                      "Strategie fuer Monat 4+",
                    ],
                  },
                ]}
              />
