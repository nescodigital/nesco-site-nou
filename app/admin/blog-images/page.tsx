...
const imageRefs: { slug: string; baseName: string }[] = [
  ...
  { slug: 'retargeting-remarketing-ghid', baseName: 'retargeting-remarketing-ghid' },
...
const articleDefs: Omit<BlogArticle, 'imageExists' | 'imageActual'>[] = [
  ...
  { slug: '/blog/geo-optimizare-ai-search/', title: 'Cum sa apari in ChatGPT si Google AI Overviews (GEO)', lang: 'RO', imageRef: '/blog/geo-optimizare-ai-search.jpg' },
  { slug: '/blog/cat-costa-un-site-web/', title: 'Cat Costa un Site Web in 2026? Ghid Complet de Preturi', lang: 'RO', imageRef: '/blog/cat-costa-un-site-web.jpg' },
  { slug: '/blog/cat-costa-google-ads-romania/', title: 'Cat costa Google Ads in Romania? Ghid de bugete 2026', lang: 'RO', imageRef: '/blog/cat-costa-google-ads-romania.jpg' },
  { slug: '/blog/abandon-cos-cumparaturi/', title: 'De ce iti abandoneaza clientii cosul (si cum repari)', lang: 'RO', imageRef: '/blog/abandon-cos-cumparaturi.jpg' },
  { slug: '/blog/seo-local-google-maps/', title: 'SEO local: Cum sa apari primul pe Google in orasul tau', lang: 'RO', imageRef: '/blog/seo-local-google-maps.jpg' },
  { slug: '/blog/facebook-ads-vs-google-ads-ecommerce/', title: 'Facebook Ads vs Google Ads: Ce alegi pentru magazinul online?', lang: 'RO', imageRef: '/blog/facebook-ads-vs-google-ads-ecommerce.jpg' },
  { slug: '/blog/ai-overviews-impact-seo/', title: 'Cum afecteaza AI Overviews SEO-ul si ce trebuie sa faci', lang: 'RO', imageRef: '/blog/ai-overviews-impact-seo.jpg' },
  { slug: '/blog/ce-este-growth-sprint/', title: 'Ce este un Growth Sprint si cum accelereaza cresterea', lang: 'RO', imageRef: '/blog/ce-este-growth-sprint.jpg' },
  { slug: '/blog/cum-alegi-agentie-marketing/', title: 'Cum sa alegi agentia de marketing potrivita: Checklist 10 pasi', lang: 'RO', imageRef: '/blog/cum-alegi-agentie-marketing.jpg' },
  { slug: '/blog/reclame-tiktok-romania/', title: 'Cum sa faci reclame pe TikTok in Romania: Ghid complet', lang: 'RO', imageRef: '/blog/reclame-tiktok-romania.jpg' },
  ...
  { slug: '/blog/creste-vanzari-magazin-online/', title: '15 strategii testate sa cresti vanzarile in magazinul online', lang: 'RO', imageRef: '/blog/creste-vanzari-magazin-online.jpg' },
  ...
  { slug: '/blog/email-marketing-ecommerce/', title: 'Email Marketing pentru Ecommerce: Cum Cresti Vanzarile', lang: 'RO', imageRef: '/blog/email-marketing-ecommerce.jpg' },
  { slug: '/blog/de-ce-nu-functioneaza-marketingul/', title: 'De ce nu functioneaza marketingul digital al afacerii tale', lang: 'RO', imageRef: '/blog/de-ce-nu-functioneaza-marketingul.jpg' },
  { slug: '/blog/linkedin-ads-b2b-romania/', title: 'LinkedIn Ads pentru B2B in Romania: Merita investitia?', lang: 'RO', imageRef: '/blog/linkedin-ads-b2b-romania.jpg' },
  { slug: '/blog/performance-max-ecommerce/', title: 'Performance Max 2026: Ghid complet pentru magazine online', lang: 'RO', imageRef: '/blog/performance-max-ecommerce.jpg' },
  { slug: '/blog/ai-in-marketing-2026/', title: 'Cum folosesc companiile AI in marketing in 2026', lang: 'RO', imageRef: '/blog/ai-in-marketing-2026.jpg' },
  { slug: '/blog/retargeting-remarketing-ghid/', title: 'Retargeting si Remarketing: Cum Recuperezi Clientii Pierduti', lang: 'RO', imageRef: '/blog/retargeting-remarketing-ghid.jpg' },
  { slug: '/blog/cum-alegi-crm/', title: 'Cum sa alegi si sa implementezi un CRM in 2026', lang: 'RO', imageRef: '/blog/cum-alegi-crm.jpg' },
  { slug: '/blog/whatsapp-business-vanzari-suport/', title: 'WhatsApp Business: Ghid complet pentru vanzari si suport', lang: 'RO', imageRef: '/blog/whatsapp-business-vanzari-suport.jpg' },
  { slug: '/blog/automatizare-marketing-ghid-tools/', title: 'Cum sa-ti automatizezi marketingul: Ghid complet de tools', lang: 'RO', imageRef: '/blog/automatizare-marketing-ghid-tools.jpg' },
  ...
  { slug: '/blog/cele-mai-bune-platforme-email-marketing/', title: 'Cele mai bune platforme de email marketing in 2026', lang: 'RO', imageRef: '/blog/cele-mai-bune-platforme-email-marketing.jpg' },
  { slug: '/blog/cele-mai-bune-landing-page-builders/', title: 'Cele mai bune landing page builders pentru conversii mai mari', lang: 'RO', imageRef: '/blog/cele-mai-bune-landing-page-builders.jpg' },
  { slug: '/blog/cele-mai-bune-chatbot-live-chat/', title: 'Cele mai bune chatbot-uri si tool-uri de live chat', lang: 'RO', imageRef: '/blog/cele-mai-bune-chatbot-live-chat.jpg' },
  // EN
  ...
  { slug: '/en/blog/geo-optimization-ai-search/', title: 'How to Appear in ChatGPT and Google AI Overviews (GEO)', lang: 'EN', imageRef: '/blog/geo-optimizare-ai-search.jpg' },
  { slug: '/en/blog/how-much-does-a-website-cost/', title: 'How Much Does a Website Cost in 2026?', lang: 'EN', imageRef: '/blog/cat-costa-un-site-web.jpg' },
  { slug: '/en/blog/how-much-does-google-ads-cost/', title: 'How Much Does Google Ads Cost? Budget Guide 2026', lang: 'EN', imageRef: '/blog/cat-costa-google-ads-romania.jpg' },
  { slug: '/en/blog/cart-abandonment-fix/', title: 'Why Customers Abandon Carts (and How to Fix It)', lang: 'EN', imageRef: '/blog/abandon-cos-cumparaturi.jpg' },
  { slug: '/en/blog/local-seo-google-maps/', title: 'Local SEO: How to Rank First on Google in Your City', lang: 'EN', imageRef: '/blog/seo-local-google-maps.jpg' },
  { slug: '/en/blog/facebook-ads-vs-google-ads-ecommerce/', title: 'Facebook Ads vs Google Ads: Which to Choose for E-commerce?', lang: 'EN', imageRef: '/blog/facebook-ads-vs-google-ads-ecommerce.jpg' },
  { slug: '/en/blog/ai-overviews-seo-impact/', title: 'How AI Overviews Affect SEO and What to Do', lang: 'EN', imageRef: '/blog/ai-overviews-impact-seo.jpg' },
  { slug: '/en/blog/what-is-growth-sprint/', title: 'What is a Growth Sprint and How It Accelerates Growth', lang: 'EN', imageRef: '/blog/ce-este-growth-sprint.jpg' },
  { slug: '/en/blog/how-to-choose-marketing-agency/', title: 'How to Choose the Right Marketing Agency: 10-Step Checklist', lang: 'EN', imageRef: '/blog/cum-alegi-agentie-marketing.jpg' },
  { slug: '/en/blog/tiktok-ads-guide/', title: 'TikTok Ads Guide: Complete Guide for Businesses', lang: 'EN', imageRef: '/blog/reclame-tiktok-romania.jpg' },
  ...
  { slug: '/en/blog/increase-online-store-sales/', title: '15 Tested Strategies to Increase Online Store Sales', lang: 'EN', imageRef: '/blog/creste-vanzari-magazin-online.jpg' },
  ...
  { slug: '/en/blog/email-marketing-ecommerce/', title: 'Email Marketing for E-commerce: How to Grow Sales', lang: 'EN', imageRef: '/blog/email-marketing-ecommerce.jpg' },
  { slug: '/en/blog/why-digital-marketing-not-working/', title: "Why Your Business's Digital Marketing Isn't Working", lang: 'EN', imageRef: '/blog/de-ce-nu-functioneaza-marketingul.jpg' },
  { slug: '/en/blog/linkedin-ads-b2b/', title: 'LinkedIn Ads for B2B: Is It Worth the Investment?', lang: 'EN', imageRef: '/blog/linkedin-ads-b2b-romania.jpg' },
  { slug: '/en/blog/performance-max-ecommerce/', title: 'Performance Max 2026: Complete Guide for Online Stores', lang: 'EN', imageRef: '/blog/performance-max-ecommerce.jpg' },
  { slug: '/en/blog/ai-in-marketing-2026/', title: 'How Companies Use AI in Marketing in 2026', lang: 'EN', imageRef: '/blog/ai-in-marketing-2026.jpg' },
  { slug: '/en/blog/retargeting-remarketing-guide/', title: 'Retargeting and Remarketing: How to Win Back Lost Customers', lang: 'EN', imageRef: '/blog/retargeting-remarketing-ghid.jpg' },
  { slug: '/en/blog/how-to-choose-crm/', title: 'How to Choose and Implement a CRM in 2026', lang: 'EN', imageRef: '/blog/cum-alegi-crm.jpg' },
  { slug: '/en/blog/whatsapp-business-sales-support/', title: 'WhatsApp Business: Complete Guide for Sales and Support', lang: 'EN', imageRef: '/blog/whatsapp-business-vanzari-suport.jpg' },
  { slug: '/en/blog/marketing-automation-tools-guide/', title: 'How to Automate Your Marketing: Complete Tools Guide', lang: 'EN', imageRef: '/blog/automatizare-marketing-ghid-tools.jpg' },
  ...
  { slug: '/en/blog/best-email-marketing-platforms/', title: 'Best Email Marketing Platforms in 2026', lang: 'EN', imageRef: '/blog/cele-mai-bune-platforme-email-marketing.jpg' },
  { slug: '/en/blog/best-landing-page-builders/', title: 'Best Landing Page Builders for Higher Conversions', lang: 'EN', imageRef: '/blog/cele-mai-bune-landing-page-builders.jpg' },
  { slug: '/en/blog/best-chatbot-live-chat-tools/', title: 'Best Chatbot and Live Chat Tools', lang: 'EN', imageRef: '/blog/cele-mai-bune-chatbot-live-chat.jpg' },
  // DE
  ...
  { slug: '/ge/blog/geo-optimierung-ai-search/', title: 'Wie Sie in ChatGPT und Google AI Overviews erscheinen (GEO)', lang: 'DE', imageRef: '/blog/geo-optimizare-ai-search.jpg' },
  { slug: '/ge/blog/was-kostet-eine-website/', title: 'Was kostet eine Website 2026? Kompletter Preis-Leitfaden', lang: 'DE', imageRef: '/blog/cat-costa-un-site-web.jpg' },
  { slug: '/ge/blog/was-kostet-google-ads/', title: 'Was kostet Google Ads? Budget-Leitfaden 2026', lang: 'DE', imageRef: '/blog/cat-costa-google-ads-romania.jpg' },
  { slug: '/ge/blog/warenkorbabbruch-beheben/', title: 'Warenkorbabbruch: Warum Kunden abbrechen und wie Sie es beheben', lang: 'DE', imageRef: '/blog/abandon-cos-cumparaturi.jpg' },
  { slug: '/ge/blog/lokales-seo-google-maps/', title: 'Lokales SEO: Wie Sie auf Google Maps in Ihrer Stadt auf Platz 1 kommen', lang: 'DE', imageRef: '/blog/seo-local-google-maps.jpg' },
  { slug: '/ge/blog/facebook-ads-vs-google-ads-ecommerce/', title: 'Facebook Ads vs Google Ads: Was wahlen fur E-Commerce?', lang: 'DE', imageRef: '/blog/facebook-ads-vs-google-ads-ecommerce.jpg' },
  { slug: '/ge/blog/ai-overviews-seo-auswirkungen/', title: 'Wie AI Overviews SEO beeinflussen und was zu tun ist', lang: 'DE', imageRef: '/blog/ai-overviews-impact-seo.jpg' },
  { slug: '/ge/blog/was-ist-growth-sprint/', title: 'Was ist ein Growth Sprint und wie beschleunigt er das Wachstum', lang: 'DE', imageRef: '/blog/ce-este-growth-sprint.jpg' },
  { slug: '/ge/blog/wie-marketing-agentur-waehlen/', title: 'Wie Sie die richtige Marketing-Agentur wahlen: 10-Schritte-Checkliste', lang: 'DE', imageRef: '/blog/cum-alegi-agentie-marketing.jpg' },
  { slug: '/ge/blog/tiktok-ads-anleitung/', title: 'TikTok Ads Anleitung: Kompletter Leitfaden fur Unternehmen', lang: 'DE', imageRef: '/blog/reclame-tiktok-romania.jpg' },
  ...
  { slug: '/ge/blog/online-shop-umsatz-steigern/', title: '15 getestete Strategien um Online-Shop-Umsatz zu steigern', lang: 'DE', imageRef: '/blog/creste-vanzari-magazin-online.jpg' },
  ...
  { slug: '/ge/blog/email-marketing-ecommerce/', title: 'E-Mail-Marketing fur E-Commerce: Wie Sie den Umsatz steigern', lang: 'DE', imageRef: '/blog/email-marketing-ecommerce.jpg' },
  { slug: '/ge/blog/warum-digitales-marketing-nicht-funktioniert/', title: 'Warum das digitale Marketing Ihres Unternehmens nicht funktioniert', lang: 'DE', imageRef: '/blog/de-ce-nu-functioneaza-marketingul.jpg' },
  { slug: '/ge/blog/linkedin-ads-b2b/', title: 'LinkedIn Ads fur B2B: Lohnt sich die Investition?', lang: 'DE', imageRef: '/blog/linkedin-ads-b2b-romania.jpg' },
  { slug: '/ge/blog/performance-max-ecommerce/', title: 'Performance Max 2026: Kompletter Leitfaden fur Online-Shops', lang: 'DE', imageRef: '/blog/performance-max-ecommerce.jpg' },
  { slug: '/ge/blog/ki-im-marketing-2026/', title: 'Wie Unternehmen KI im Marketing 2026 nutzen', lang: 'DE', imageRef: '/blog/ai-in-marketing-2026.jpg' },
  { slug: '/ge/blog/retargeting-remarketing-leitfaden/', title: 'Retargeting und Remarketing: Wie Sie verlorene Kunden zuruckgewinnen', lang: 'DE', imageRef: '/blog/retargeting-remarketing-ghid.jpg' },
  { slug: '/ge/blog/wie-crm-waehlen/', title: 'Wie Sie ein CRM wahlen und implementieren 2026', lang: 'DE', imageRef: '/blog/cum-alegi-crm.jpg' },
  { slug: '/ge/blog/whatsapp-business-vertrieb-support/', title: 'WhatsApp Business: Kompletter Leitfaden fur Vertrieb und Support', lang: 'DE', imageRef: '/blog/whatsapp-business-vanzari-suport.jpg' },
  { slug: '/ge/blog/marketing-automatisierung-tools-leitfaden/', title: 'Wie Sie Ihr Marketing automatisieren: Kompletter Tools-Leitfaden', lang: 'DE', imageRef: '/blog/automatizare-marketing-ghid-tools.jpg' },
  ...
  { slug: '/ge/blog/beste-email-marketing-plattformen/', title: 'Beste E-Mail-Marketing-Plattformen 2026', lang: 'DE', imageRef: '/blog/cele-mai-bune-platforme-email-marketing.jpg' },
  { slug: '/ge/blog/beste-landing-page-builder/', title: 'Beste Landing Page Builder fur hohere Conversions', lang: 'DE', imageRef: '/blog/cele-mai-bune-landing-page-builders.jpg' },
  { slug: '/ge/blog/beste-chatbot-live-chat-tools/', title: 'Beste Chatbot- und Live-Chat-Tools', lang: 'DE', imageRef: '/blog/cele-mai-bune-chatbot-live-chat.jpg' },
];
