...
export const metadata: Metadata = buildMetadata({
  locale: "ro",
  title: "Growth Sprint pentru E-Commerce | Rezolvăm Scurgerile de Profit | Nesco Digital",
  description:
    "Un angajament de 6 săptămâni pentru branduri de e-commerce mid-to-high ticket cu venituri de 50k–500k+/lună. Audităm fiecare sistem de venituri și implementăm soluțiile cu cel mai mare impact.",
  path: "/growth-sprint-ecommerce-ro/",
...
const included = {
  audit: [
    ...
    ["Analiza conversiei produs & checkout", "Unde pierzi cumpărători"],
    ["Audit venituri email și SMS", "Fluxuri, secvențe, venituri per abonat"],
    ["Structura AOV și LTV", "Upsell-uri, bundle-uri, rate de cumpărare repetată"],
    ["Revizuire operațională", "Fricțiunea livrării, blocaje de echipă, goluri de proces"],
    ["Structura KPI și tracking", "Măsori ce contează cu adevărat?"],
  ],
  impl: [
    ["Rezolvarea scurgerilor de conversie și retenție", "Cele mai importante din audit"],
    ["Reconstruirea fluxurilor de email și SMS", "Fluxuri cu performanță slabă, reconstruite"],
    ["Restructurarea strategiei de achiziție", "Pentru profitabilitate, nu doar volum"],
    ["Implementarea îmbunătățirilor AOV și LTV", "Fluxuri upsell, structuri bundle"],
    ["Configurarea sistemelor de tracking KPI", "Raportare care îți spune ce contează"],
  ],
};

const forList = [
  "Branduri de e-commerce la 50k–500k+/lună cu cheltuieli reale de reclame și operațiuni existente",
  "Fondatori care simt că creșterea a stagnat în ciuda cheltuielilor de marketing crescute",
  "Antreprenori care vor un operator, nu un alt furnizor",
  "Branduri cu un tech stack existent, Shopify, Klaviyo, Meta, Google, gata să fie optimizat",
];

const notForList = [
  "Branduri care nu au atins venituri lunare consistente",
  "Afaceri care caută pe cineva să le gestioneze reclamele zilnic",
  "Fondatori care vor slide-uri de strategie, nu implementare",
];

export default function GrowthSprintEcommerceRoPage() {
  return (
    <>
      <Header locale="ro" />
      <main style={{ backgroundColor: "#050505" }}>
        ...
        >
          ...
          <div className="relative max-w-7xl mx-auto px-[5%]" style={{ zIndex: 1 }}>
            ...
            >
              Pentru branduri de e-commerce mid-to-high ticket cu venituri de{" "}
              <strong style={{ color: "#ffffff", fontWeight: 700 }}>50k–500k+/lună</strong>{" "}
              care scalează bugetele de reclame dar nu scalează profitul.
            </p>
            <p
              style={{
                fontSize: "1rem",
            ...
            >
              ...
              în care operăm direct în afacerea ta de e-commerce, audităm fiecare sistem de venituri și implementăm cele mai importante soluții. Nu producem rapoarte. Implementăm.
            </p>
            ...
            >
              {[
                ...
                { value: "50k–500k+", label: "Venituri lunare" },
                { value: "Fără rapoarte", label: "Doar implementare" },
              ].map((s, i) => (
                <div key={i}>
                  <div
          ...
          <div className="max-w-7xl mx-auto px-[5%]">
            <FadeInSection>
              <div style={{ maxWidth: "680px" }}>
                ...
                >
                  Scalezi cheltuielile pe reclame.{" "}
                  <span style={{ color: "rgba(255,255,255,0.35)" }}>Nu scalezi profitul.</span>
                </h2>
                <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                  <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.8 }}>
                    Rulezi reclame. Ai trafic. Procesezi comenzi. Dar marjele tale sunt mai mici decât ar trebui, ROAS-ul continuă să scadă, și cu cât cheltuiești mai mult, cu atât pare mai puțin profitabil.
                  </p>
                  <p style={{ fontSize: "1rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.8 }}>
                    Ai optimizat ce poți vedea, reclamele, poate pagina principală. Dar scurgerile reale sunt ascunse: în drop-off-urile funnel-ului, în performanța slabă a email-ului și SMS-ului, în golurile de AOV și LTV și în fricțiunea operațională care ucide eficiența în liniște.
                  </p>
                  <p
                    style={{
                      fontSize: "1rem",
                  ...
                  >
                    Nu ai nevoie de o altă agenție care să-ți gestioneze campaniile. Ai nevoie de cineva care să intre în afacere, să găsească unde se scurge banii și să{" "}
                    <span style={{ color: "#56db84" }}>închidă golurile.</span>
                  </p>
                </div>
              </div>
            </FadeInSection>
          ...
          <div className="max-w-7xl mx-auto px-[5%]">
            <FadeInSection>
              ...
              >
                ...
                >
                  Nu producem rapoarte. Implementăm.
                </h2>
                <p style={{ fontSize: "1.0625rem", color: "rgba(255,255,255,0.45)", lineHeight: 1.8, marginBottom: "16px" }}>
                  Un angajament concentrat de 6 săptămâni în care Nesco Digital operează direct în afacerea ta de e-commerce, auditând fiecare sistem de venituri și implementând cele mai importante soluții în achiziție, conversie, retenție și operațiuni.
                </p>
              ...
              >
                ...
                <div>
                  ...
                  <p style={{ fontSize: "0.875rem", color: "rgba(255,255,255,0.4)", lineHeight: 1.7 }}>
                    Un sistem de venituri mai profitabil și cu conversie mai bună, implementat, documentat și pregătit să scaleze.{" "}
              ...
              <FadeInSection delay={120}>
                ...
                >
                  ...
                  <p style={{ fontSize: "0.8125rem", color: "rgba(255,255,255,0.35)", marginBottom: "8px", lineHeight: 1.6 }}>
                    3.250 € la semnare + 3.250 € în Săptămâna 3
                  </p>
